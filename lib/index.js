...
var log = {
    info: console.log.bind(console, chalk_1.default.gray.bold(name)),
    warning: console.error.bind(console, chalk_1.default.yellow(name)),
    error: console.error.bind(console, chalk_1.default.red(name)),
